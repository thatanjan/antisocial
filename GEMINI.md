# antisocial Development Guidelines
...
- TypeScript (strict mode) + Shadcn UI (Sheet, ScrollArea, Avatar, Input, Button), Lucide React (003-side-navs)
...
## Recent Changes
- 007-post-comments: Added TypeScript (strict mode) + Shadcn UI, React Hook Form, Zod, Better Auth
