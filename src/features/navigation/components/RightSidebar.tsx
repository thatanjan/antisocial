...
export const RightSidebar = () => {
  return (
    <aside className="sticky top-0 hidden h-screen w-col-side min-w-col max-w-col-side flex-col overflow-hidden border-border border-l bg-card/30 backdrop-blur-md xl:flex">
